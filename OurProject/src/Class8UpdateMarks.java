...
import java.awt.*;
import java.sql.*;
public class Class8UpdateMarks extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Class8UpdateMarks.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Class8UpdateMarks().setVisible(true);
            }
        });
    }
