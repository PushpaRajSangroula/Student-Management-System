...
import java.awt.*;
import java.sql.*;
public class Class3Marks extends javax.swing.JFrame {
    ...
    public void subjectNameSetter(){
        //for class 3
        jLabel7.setText(sif2.jLabel45.getText());
        jLabel9.setText(sif2.jLabel100.getText());
        jLabel10.setText(sif2.jLabel101.getText());
        jLabel11.setText(sif2.jLabel102.getText());
        jLabel12.setText(sif2.jLabel103.getText()); 
        jLabel13.setText(sif2.jLabel110.getText());
        
    }
    public void fullMarksSetter(){

        //for class 3
        jLabel8.setText(((Integer.parseInt(sif2.jTextField191.getText())) + (Integer.parseInt(sif2.jTextField197.getText()))) + "");
        jLabel15.setText(((Integer.parseInt(sif2.jTextField192.getText())) + (Integer.parseInt(sif2.jTextField198.getText()))) + "");
        jLabel16.setText(((Integer.parseInt(sif2.jTextField193.getText())) + (Integer.parseInt(sif2.jTextField199.getText()))) + "");
        jLabel17.setText(((Integer.parseInt(sif2.jTextField194.getText())) + (Integer.parseInt(sif2.jTextField200.getText()))) + "");
        jLabel18.setText(((Integer.parseInt(sif2.jTextField195.getText())) + (Integer.parseInt(sif2.jTextField201.getText()))) + "");
        jLabel19.setText(((Integer.parseInt(sif2.jTextField210.getText())) + (Integer.parseInt(sif2.jTextField211.getText()))) + "");
    ...
    public void passMarksSetter(){
        ...
        jLabel21.setText(sif2.jTextField203.getText());
        jLabel33.setText(sif2.jTextField204.getText());
        jLabel35.setText(sif2.jTextField205.getText());
        jLabel36.setText(sif2.jTextField206.getText());
        jLabel38.setText(sif2.jTextField207.getText());
        jLabel39.setText(sif2.jTextField212.getText());
    ...
    private void jPanel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel3MouseClicked
        try{
            ...
            omSerofero = jTextField5.getText();
            omLocalSubject = jTextField8.getText();
            ...
            marksSerofero = Integer.parseInt(omSerofero);
        ...
        try{
                ...
                if(omNepali.equals("")||omEnglish.equals("")||omMaths.equals("")||omScience.equals("")||omSerofero.equals("")||omLocalSubject.equals("")){
                    ...
                    else if(marksSerofero >= 80 && marksSerofero < 90){
                        gSerofero = "A";
                    }
                    else if(marksSerofero >= 70 && marksSerofero < 80){
                        gSerofero = "B+";
                    }
                    else if(marksSerofero >= 60 && marksSerofero < 70){
                        gSerofero = "B";
                    }
                    else if(marksSerofero >= 50 && marksSerofero < 60){
                        gSerofero = "C+";
                    }
                    else if(marksSerofero >= 40 && marksSerofero < 50){
                        gSerofero = "C";
                    }
                    else if(marksSerofero >= 35 && marksSerofero < 40){
                        gSerofero = "D";
                    }
                    else{
                        gSerofero = "NG";
                    ...
                    fmSerofero = Integer.parseInt(jLabel18.getText());
                    fmLocalSubject = Integer.parseInt(jLabel19.getText());
                    
                    //obtaining the total full marks
                    total = fmNepali + fmEnglish + fmMaths + fmScience + fmSerofero + fmLocalSubject;
                    
                    //obtaining the total obtained marks
                    totalom = marksNepali + marksEnglish + marksMaths + marksScience + marksSerofero + marksLocalSubject;
                    ...
                    pst2 = con.prepareStatement("INSERT INTO obtainedmarks (regid, nepali, english, maths, science, hamroserofero, localsubject, gpa, remarks) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
                    ...
                    pst2.setString(6, gSerofero);
                    pst2.setString(7, gLocalSubject);
                    pst2.setString(8, ogpa);
                    pst2.setString(9, remark);
                    
                    pst2.executeUpdate();
                    
                    
                    //uploading marks into the database table called "studentmarks", for class 3
                    pst3 = con.prepareStatement("INSERT INTO studentmarks(regid, nepali, english, maths, science, serofero, localsubject) VALUES(?,?,?,?,?,?,?)");
                    ...
                    pst3.setInt(6, marksSerofero);
                    pst3.setInt(7, marksLocalSubject);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Class3Marks.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Class3Marks().setVisible(true);
            }
        });
    }
