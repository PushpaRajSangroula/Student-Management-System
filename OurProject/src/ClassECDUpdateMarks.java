...
import java.awt.*;
import java.sql.*;
public class ClassECDUpdateMarks extends javax.swing.JFrame {

    /**
     * Creates new form ClassECDUpdateMarks
     */
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addComponent(jLabel28, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 177, Short.MAX_VALUE)
        );
    ...
    private void jPanel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel3MouseClicked
        ...
        newDrawing = jTextField5.getText();
        ...
        try{
            ...
            intDrawing = Integer.parseInt(newDrawing);
            ...
            //now assigning the respective subjectwise grade value for each subjects according to the obtained marks
                    ...
                    else if(intDrawing >= 80 && intDrawing < 90){
                        newGDrawing = "A";
                    }
                    else if(intDrawing >= 70 && intDrawing < 80){
                        newGDrawing = "B+";
                    }
                    else if(intDrawing >= 60 && intDrawing < 70){
                        newGDrawing = "B";
                    }
                    else if(intDrawing >= 50 && intDrawing < 60){
                        newGDrawing = "C+";
                    }
                    else if(intDrawing >= 40 && intDrawing < 50){
                        newGDrawing = "C";
                    }
                    else if(intDrawing >= 35 && intDrawing < 40){
                        newGDrawing = "D";
                    }
                    else{
                        newGDrawing = "NG";
        ...
        totalfm = Integer.parseInt(jLabel8.getText()) + Integer.parseInt(jLabel15.getText()) + Integer.parseInt(jLabel16.getText()) + Integer.parseInt(jLabel17.getText()) + Integer.parseInt(jLabel18.getText());
        
        //determining the total obtained marks
        totalom = intNepali + intEnglish + intMaths + intScience + intDrawing;
        ...
        //determining the gpa and remark
            ...
            //now performing not null validation and sql updation process      
                ...
                if(rs1.next()){
                        ...
                        pst1 = con.prepareStatement("UPDATE obtainedmarks SET nepali = ?, english = ?, maths = ?, science = ?, drawing = ?, gpa = ?, remarks = ? WHERE regid = ?");
                        pst1.setString(1, newGNepali);
                        pst1.setString(2, newGEnglish);
                        pst1.setString(3, newGMaths);
                        pst1.setString(4, newGScience);
                        pst1.setString(5, newGDrawing);
                        pst1.setString(6, newGPA);
                        pst1.setString(7, remark);
                        
                        pst1.setString(8, enteredRegID);
                        pst1.executeUpdate();
                   
                        //also updating in "studentmarks" table
                        pst2 = con.prepareStatement("UPDATE studentmarks SET nepali = ?, english = ?, maths = ?, science = ?, drawing = ? WHERE regid = ?");
                        pst2.setInt(1, intNepali);
                        pst2.setInt(2, intEnglish);
                        pst2.setInt(3, intMaths);
                        pst2.setInt(4, intScience);
                        pst2.setInt(5, intDrawing);
                        pst2.setString(6, enteredRegID);  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClassECDUpdateMarks.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClassECDUpdateMarks().setVisible(true);
            }
        });
    }
